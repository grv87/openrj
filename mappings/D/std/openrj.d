...
public:
	...
	Field dup()
	{
		return new Field(m_name, m_value);
	}
/// @}
...
/// @{
private:
    this(Field[] fields, uint flags, Database database, char[] comment)
    {
        m_fields = fields.dup;
...
//                      printf("-- record --\n");
                        ...
                        {
							char[]	comment	=	nextLine[2 .. nextLine.length];
                            Record  record  =   new Record(fields, flags, this, stripl(stripr(comment)));
